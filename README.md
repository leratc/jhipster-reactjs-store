...
To build the final jar and optimize the jhipsterReactjsStore application for production, run:
...
Then navigate to [http://localhost:80110](http://localhost:80110) in your browser.
